...
export default function InteriorArchitectCareerPage() {
  return (
    <>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              An Interior Architect plans and designs the interior spaces of buildings, considering both aesthetics and functionality.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Interior Architects may work on homes and apartments, offices, hotels, restaurants, retail stores, hospitals, educational institutions, commercial buildings and public spaces.
            </p>
            <p className="text-slate-700 leading-relaxed text-base">
              The profession combines creative design with technical understanding, requiring professionals to consider how people use and experience a space.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              These careers are related but different.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Important: The title and scope of professional architectural practice in India are regulated under the Architects Act, 1972. Students should understand the distinction before choosing an architecture or interior-design qualification.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              There is no single compulsory school stream for every Interior Design or Interior Architecture programme.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              This can be particularly useful if you want to pursue a more architecture- and technically-oriented pathway.
            </p>
            <p className="font-bold text-slate-800 text-base">Useful subjects include:</p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
              ...
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Computer Science</div>
            </div>
            <p className="font-bold text-slate-800 text-base pt-2">Commerce or Arts / Humanities</p>
            <p className="text-slate-700 leading-relaxed text-base">
              These streams can also be suitable for many interior-design programmes.
            </p>
            <p className="font-bold text-slate-800 text-base">Useful subjects may include:</p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Fine Arts</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Design</div>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              The best stream depends on the specific degree and college you plan to apply to.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              Mathematics requirements depend on the course you choose.
            </p>
            <p className="text-slate-700 leading-relaxed text-base">
              For a conventional B.Arch pathway, Mathematics in Class 12 is an important eligibility requirement under the applicable regulations.
            </p>
            <p className="text-slate-700 leading-relaxed text-base">
              For many Interior Design / Interior Architecture / Design programmes, however, Mathematics may not be compulsory.
            </p>
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Therefore, if you are considering Interior Architecture as a career, check the eligibility criteria of your target colleges before selecting your Class 11 subjects. If you enjoy Mathematics, keeping it can provide greater flexibility—particularly if you may later consider Architecture.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              There are several possible educational pathways.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              The right choice depends on whether you want to focus primarily on interior design, interior architecture or professional architecture.
            </p>
            <p className="font-bold text-slate-800 text-base pt-2">What Should You Look for in a Course?</p>
            <p className="text-slate-700 leading-relaxed text-base">
              A strong programme should include exposure to design fundamentals, space planning, architectural drawing, materials, furniture design, lighting, building services, 2D and 3D design, CAD, 3D modelling, building documentation, sustainable design, construction techniques and portfolio development.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              Entrance requirements depend on the course and institution.
            </p>
            <p className="font-bold text-slate-800 text-base">For undergraduate design programmes, students may encounter:</p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> NID DAT</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> UCEED</div>
              ...
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Institution-specific design aptitude tests</div>
            ...
            <p className="font-bold text-slate-800 text-base pt-2">For students choosing B.Arch., the admission pathway can involve:</p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> NATA – National Aptitude Test in Architecture</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> JEE Main Paper 2, depending on the institution</div>
            </div>
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Students should always verify the latest eligibility and admission requirements before applying.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              There is no single universally accepted ranking of the best Interior Design colleges in India.
            </p>
            <p className="text-slate-700 leading-relaxed text-base">
              Students should look for institutions with strong design faculty, studio-based learning, industry exposure, practical projects, construction and material exposure, CAD and 3D software training, internships, portfolio development, professional practitioners as faculty and strong alumni network.
            </p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Don&apos;t choose a college only because it has “Interior Design” in the course title. The quality of studio work, practical exposure, faculty and portfolio development can make a major difference.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              The Interior Architect salary in India varies depending on qualification, experience, location, employer, specialisation and whether the professional works independently or with a design firm.
            </p>
            <p className="font-bold text-slate-800 text-base">Career progression may include:</p>
            <p className="text-slate-700 leading-relaxed text-base">Junior Designer → Interior Designer / Interior Architect → Senior Designer → Design Lead → Design Director</p>
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Experienced professionals may also establish their own interior design studio or consultancy.
            </p>
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Because compensation varies significantly across employers and independent practices, students should evaluate the profession based on career growth, portfolio, skills and entrepreneurship opportunities, rather than relying on a single salary figure.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              The future scope of Interior Architecture and Interior Design in India is linked to growth in residential, commercial, hospitality, retail, healthcare and workplace projects.
            </p>
            <p className="font-bold text-slate-800 text-base">Career opportunities exist in:</p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Interior design studios</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Architecture firms</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Real-estate companies</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Construction companies</div>
              ...
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Corporate workplaces</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Furniture companies</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Modular kitchen companies</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Real-estate development</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Exhibition and experiential design</div>
              <div className="flex items-center gap-2.5"><CheckCircle2 size={18} className="text-brand-blue shrink-0" /> Freelancing</div>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              Technology is increasingly becoming part of the design workflow, making knowledge of CAD, 3D modelling, rendering and digital visualisation increasingly valuable.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              Interior Architecture requires a combination of creative, technical and interpersonal skills.
            </p>
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">
              Interior Architecture could be a good career choice if you:
            </p>
            <div className="grid sm:grid-cols-2 gap-2 text-slate-700 text-base pl-2">
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              It may not be suitable if you dislike revisions, deadlines, technical drawings, client feedback or managing practical constraints.
            </p>
            <p className="text-slate-700 leading-relaxed text-base pt-2">
              And remember: being good at decorating a room is not the same as being an Interior Designer or Interior Architect.
            </p>
            <p className="text-slate-700 leading-relaxed text-base">
              Professionals need to understand space, functionality, materials, construction, safety, technology and the needs of the people using the space.
            </p>
          </div>
          ...
          <div className="bg-brand-blue text-white p-8 md:p-12 rounded-3xl shadow-xl text-center space-y-6">
            ...
            <p className="text-white/90 text-lg max-w-2xl mx-auto leading-relaxed">
              Choosing a creative career should go beyond asking, “Am I artistic?”
            </p>
            <p className="text-white/90 text-base max-w-2xl mx-auto leading-relaxed">
              Your interests, personality, strengths and skills can help you understand whether Interior Architecture, Interior Design, Architecture or another creative career is the right fit for you.
            </p>
            <p className="text-white/90 text-base max-w-2xl mx-auto leading-relaxed">
