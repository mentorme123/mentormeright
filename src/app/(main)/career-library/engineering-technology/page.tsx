      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto space-y-10">
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            ...
            <p className="text-slate-700 leading-relaxed text-base">A Data Scientist collects, analyses and interprets large amounts of data to identify patterns, solve business problems and predict future outcomes.</p>
            <p className="text-slate-700 leading-relaxed text-base">A Data Scientist may work on data analysis, machine learning, artificial intelligence, predictive modelling, data visualisation and statistical analysis.</p>
            <p className="text-slate-700 leading-relaxed text-base">Typical employers include technology companies, banks, consulting firms, healthcare companies, e-commerce companies, manufacturing organisations and Global Capability Centres (GCCs).</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">What Subjects Should I Take After 10th?</h2>
            <p className="text-slate-700 leading-relaxed text-base">If you want to become a Data Scientist, Science with Mathematics is generally the strongest choice after Class 10.</p>
            <p className="text-slate-700 leading-relaxed text-base">Data Science relies heavily on mathematical and analytical thinking, so keeping Mathematics and taking subjects such as Physics, Chemistry and Computer Science can provide a strong foundation.</p>
            <p className="text-slate-700 leading-relaxed text-base">However, students from other streams can also enter Data Science through undergraduate programmes, bootcamps and specialised training.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">Which Degree Should I Choose?</h2>
            <p className="text-slate-700 leading-relaxed text-base">There is no single mandatory degree for Data Science, but quantitative and technical programmes are the most common pathways.</p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">Many Data Scientists also pursue postgraduate qualifications such as M.Sc. Data Science, M.Tech, MBA in Business Analytics or specialised certification programmes.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">Which Entrance Exams Should I Take?</h2>
            <p className="text-slate-700 leading-relaxed text-base">The entrance exam depends on the degree and institution you choose.</p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">For postgraduate studies in Data Science, common entrance exams include GATE, CAT, XAT, GMAT and university-specific tests.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">Best Colleges for Data Science in India</h2>
            <p className="text-slate-700 leading-relaxed text-base">There is no single definitive list, but strong programmes are offered by leading IITs, IISc, top universities and specialised analytics institutes.</p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">Look for programmes with strong mathematics, statistics, programming, machine learning and industry project components.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">What Certifications Can Help?</h2>
            <p className="text-slate-700 leading-relaxed text-base">Certifications can strengthen a Data Science profile, especially when combined with projects and practical experience.</p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">While certifications add value, employers also value projects, internships, open-source contributions and demonstrable analytical work.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">What Is the Future Scope of Data Science?</h2>
            <p className="text-slate-700 leading-relaxed text-base">The future scope of Data Science in India is strong across almost every industry.</p>
            ...
            <p className="text-slate-700 leading-relaxed text-base pt-2">Emerging areas include machine learning, artificial intelligence, generative AI, data engineering, analytics, automation and decision intelligence.</p>
          </div>
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
            <h2 className="text-2xl font-black text-slate-900">Skills Required to Become a Data Scientist</h2>
            <p className="text-slate-700 leading-relaxed text-base">A successful Data Scientist needs a combination of technical, analytical and business skills.</p>
          ...
          <div className="bg-brand-blue text-white p-8 md:p-12 rounded-3xl shadow-xl text-center space-y-6">
            ...
            <p className="text-white/90 text-base max-w-2xl mx-auto leading-relaxed">Your interests, strengths, personality and skills can help determine whether Data Science is actually a good fit for you.</p>
