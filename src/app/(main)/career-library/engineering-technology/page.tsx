export const metadata = {
  title: "Engineering & Technology Careers | MentorMe Career Library",
  description: "Explore detailed career roadmaps for Engineering and Technology careers in India.",
};

export default function EngineeringTechnologyLanding() {
  return (
    <>
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-3xl border border-slate-200 shadow-sm space-y-4">
          ...
          <p className="text-slate-700 leading-relaxed text-base">
            Use the left sidebar to browse career roadmaps in Engineering &amp; Technology.
          </p>
        </div>
      </section>
    </>
