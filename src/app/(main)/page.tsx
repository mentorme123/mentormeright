...
import { Users, Briefcase, GraduationCap, Globe2, ArrowRight, CheckCircle2, Phone, Mail, MapPin, X, Loader2 } from "lucide-react";
              ...
              {enquirySuccess ? (
                ...
                <form onSubmit={handleEnquirySubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className={`w-full py-4 rounded-xl text-white font-black text-base shadow-lg transition-all active:scale-95 ${enquirySubmitting ? "bg-slate-300" : "bg-brand-orange hover:bg-brand-orange/90"}`}
                  >
