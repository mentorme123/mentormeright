...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] overflow-hidden w-full max-w-full">
      ...
      {/* About MentorMe Section */}
      <section className="py-24 px-4 bg-gradient-to-br from-[#f8faff] via-white to-[#fff7f0] relative overflow-hidden">
        {/* Decorative blobs */}
        <div className="absolute top-0 left-0 w-[420px] h-[420px] bg-brand-blue/5 rounded-full blur-3xl -ml-56 -mt-56 pointer-events-none" />
        <div className="absolute bottom-0 right-0 w-[360px] h-[360px] bg-brand-orange/5 rounded-full blur-3xl -mr-40 -mb-40 pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto space-y-16 relative z-10">
          ...
          >
            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-brand-orange/10 text-brand-orange text-sm font-bold border border-brand-orange/20 tracking-wide uppercase">
              🎓 About MentorMe
            </span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-foreground">
              MentorMe – AI-Powered{" "}
              <span className="text-brand-blue">Career Guidance</span> &amp;{" "}
              <span className="text-brand-orange">Career Counselling</span> Platform
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              MentorMe is India&apos;s leading AI-powered Career Guidance and Career Counselling platform, dedicated to helping students, professionals, and institutions make smarter, data-driven career decisions. We combine cutting-edge Artificial Intelligence, scientifically validated Psychometric Assessments, and expert human counselling to deliver personalised career roadmaps for every stage of the learning journey.
            </p>
          </motion.div>
          ...
          >
            <div className="space-y-5">
              <p className="text-base text-muted-foreground leading-relaxed">
                Founded with a mission to democratise quality career counselling, MentorMe leverages AI to evaluate a learner&apos;s personality, interests, aptitude, skills, and values — generating deep insights that map uniquely to hundreds of career pathways across Science, Commerce, Arts, and emerging fields.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                Our platform serves school students from Grade 6 to Grade 12 exploring stream selection and future careers, college students planning higher education and career transitions, and working professionals seeking growth, upskilling, or a meaningful career change.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                We also partner with schools, colleges, and corporates to deliver institutional career guidance programs, AI &amp; Robotics skill development initiatives, employability training, and study abroad counselling — empowering institutions to build future-ready talent at scale.
              </p>
            </div>
            <div className="space-y-5">
              <p className="text-base text-muted-foreground leading-relaxed">
                MentorMe&apos;s AI-powered career assessment goes beyond traditional counselling by generating a comprehensive, personalised Career Report that covers career recommendations, subject stream guidance, college admission pathways, skill gap analysis, and a structured career action plan tailored to each individual.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                With a network of certified career counsellors, industry mentors, and academic experts, MentorMe ensures every student and professional receives both the intelligence of AI and the wisdom of human experience — making confident career decisions accessible to all.
              </p>
              <div className="flex flex-wrap gap-3 pt-2">
                {[
                  ...
                  <span
                    key={tag}
                    className="px-3 py-1.5 rounded-full bg-brand-blue/8 text-brand-blue text-xs font-semibold border border-brand-blue/15"
                  >
                    {tag}
                  </span>
                ))}
            ...
            {[
              {
                ...
                desc: "Scientifically validated psychometric assessments combined with AI insights to deliver personalised career roadmaps. Get clarity on what to study, which college to attend, and which career truly fits your potential.",
              },
              {
                icon: "🧠",
                ...
                desc: "One-on-one sessions with certified career counsellors who understand your unique strengths, goals, and challenges. Backed by AI data, our counsellors provide actionable, human guidance at every critical decision point.",
              },
              {
                icon: "🚀",
                ...
                desc: "Future-focused programs in AI, Robotics, Data Analytics, Digital Marketing, and more — designed to equip students and professionals with the 21st-century skills demanded by today's rapidly evolving job market.",
              },
            ].map((pillar, i) => (
              <motion.div
                key={i}
                ...
                className={`rounded-2xl border p-7 flex flex-col gap-4 hover:-translate-y-1 transition-all duration-300 shadow-sm hover:shadow-lg ${pillar.bg}`}
              >
                <div className={`w-13 h-13 w-12 h-12 rounded-xl bg-gradient-to-br ${pillar.color} flex items-center justify-center text-2xl shadow-md`}>
                  {pillar.icon}
                </div>
          ...
          >
            <Link href="/free-mini-assessment.html">
              <button className="px-9 py-4 bg-brand-orange hover:bg-brand-orange/90 text-white font-extrabold text-base rounded-xl shadow-lg shadow-brand-orange/25 transition-all hover:scale-105 active:scale-95">
                Take Free Career Assessment
              </button>
            </Link>
            <Link href="/services">
              <button className="px-9 py-4 border-2 border-brand-blue text-brand-blue font-extrabold text-base rounded-xl hover:bg-brand-blue hover:text-white transition-all duration-300">
