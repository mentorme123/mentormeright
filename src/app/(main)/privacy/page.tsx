export default function PrivacyPolicyPage() {
  return (
    <div className="bg-slate-50 min-h-screen py-20 px-4">
      <div className="max-w-4xl bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200">
        <h1 className="text-4xl md:text-5xl font-black text-brand-blue mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          <section>
            ...
            <p>
              Welcome to MentorMe (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;). We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Assessment Data:</strong> includes psychometric test results, career preferences, and educational history.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>Where we need to perform the contract we are about to enter into or have entered into with you (e.g., providing career counseling).</li>
          ...
          <section>
            ...
            <p>
              If you have any questions about this privacy policy or our privacy practices, please contact us at <strong>admin@mentormeright.in</strong>.
            </p>
          </section>
        </div>
      </div>
