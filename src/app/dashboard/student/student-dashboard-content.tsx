      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {assessmentStatus === 'completed' ? (
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
            ...
            <Link href="https://mentormeright-gt7dzpp8x-mentorme123s-projects.vercel.app/assessment" className="inline-block mt-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-sm">
              ...
              <Link href={assessmentStatus === 'completed' ? "/report" : "https://mentormeright-gt7dzpp8x-mentorme123s-projects.vercel.app/assessment"}>
