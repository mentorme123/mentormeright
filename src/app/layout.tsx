  ...
  return (
    <html lang="en" className={cn("font-sans", poppins.variable)}>
      <body className="antialiased min-h-screen flex flex-col font-sans">
        ...
        {/* WhatsApp Floating Button - Priority Executive Line */}
        <a 
          href="https://wa.me/917674982983" 
          target="_blank" 
        ...
        >
          ...
          <span className="absolute left-16 bg-white text-[#25D366] px-3 py-1 rounded-lg text-xs font-black shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-slate-100">
            Chat with Experts
          </span>
        </a>
