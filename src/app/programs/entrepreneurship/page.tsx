      ...
      <div className="bg-[#0a1628] text-white border-b border-slate-700">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-bold">Module 1: Entrepreneurial Mindset</h2>
              <p className="text-xs text-slate-400">Building the Foundation for Business Success</p>
            </div>
          </div>
