...
import { BookOpen, ChevronLeft, ChevronRight, Home, Search, ZoomIn, ZoomOut, ArrowLeft } from "lucide-react";
      ...
      <div className="bg-[#0a1628] text-white border-b border-slate-700">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm sm:text-base font-bold">{MODULES[active].title}</h2>
              <p className="text-xs text-slate-400">{MODULES[active].description}</p>
            </div>
          </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-80 shrink-0">
            <div className="bg-[#0a1628] rounded-2xl p-6 text-white mb-4">
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <img src="/logo.png" alt="MentorMe" className="h-10 w-auto" />
          </Link>
          <div className="hidden md:flex items-center gap-6">
            <Link href="/" className="text-sm font-medium text-slate-700 hover:text-brand-blue">Home</Link>
            <Link href="/about" className="text-sm font-medium text-slate-700 hover:text-brand-blue">About</Link>
            <Link href="/ai-learning-hub" className="text-sm font-medium text-slate-700 hover:text-brand-blue">AI Learning Hub</Link>
            <Link href="/skills-hub" className="text-sm font-medium text-slate-700 hover:text-brand-blue">21st Century Skills Hub</Link>
            <Link href="/blogs" className="text-sm font-medium text-slate-700 hover:text-brand-blue">Blogs</Link>
            <Link href="/contact" className="text-sm font-medium text-slate-700 hover:text-brand-blue">Contact Us</Link>
          ...
          <div className="flex items-center gap-3">
            <Link href="/career-assessment.html">
              <Button className="bg-brand-orange hover:bg-brand-orange/90 text-white text-sm font-bold px-4 py-2 rounded-lg">
                Free Mini Psychometric Assessment
              </Button>
            </Link>
            <Link href="/login">
              <Button className="bg-brand-blue hover:bg-brand-blue/90 text-white text-sm font-bold px-4 py-2 rounded-lg">
                Login / Register
              </Button>
            </Link>
          </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-4 mb-4 w-80">
          <div className="flex items-center gap-3 mb-2">
            <div className="w-8 h-8 rounded-lg bg-brand-blue flex items-center justify-center">
              <BookOpen size={18} className="text-white" />
            </div>
            <div>
              <p className="font-bold text-sm text-slate-800">AI Corner</p>
