          ...
          {!isMinimized && (
            <>
              ...
              <div className="px-4 py-2 bg-white border-t border-slate-100 flex gap-2 overflow-x-auto flex-shrink-0">
                <Link href="https://mentormeright-gt7dzpp8x-mentorme123s-projects.vercel.app/assessment" className="px-3 py-1.5 bg-brand-orange/10 text-brand-orange text-xs font-black rounded-lg whitespace-nowrap hover:bg-brand-orange/20 transition-colors">
                  Free Test 🎯
                </Link>
